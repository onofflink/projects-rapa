...
function createPeerConnection(isInitiator, config) {
  ...
  //RTCPeerConnection 을 통해서 원격 연결을 한다 
...
if (isInitiator) {
  ...
  //photos 라는 데이터 채널을 연다 
  dataChannel = peerConn.createDataChannel('photos');
  
  onDataChannelCreated(dataChannel); //데이터 채널 연결하고나서
  //onDataChannelCreated 가 처리한다  
